<!-- components/modals/WarningModal.vue -->
<template>
    <div 
    ...
    >
        <div class="bg-white rounded-lg p-7 max-w-sm w-full mx-4 shadow-2xl border border-yellow-200">
            ...
            <div class="flex justify-end pt-2 border-t border-gray-100">
                <button 
                    @click="closeModal"
                    class="px-5 py-2 bg-yellow-600 hover:bg-yellow-700 text-white rounded-lg transition-all duration-200 text-sm font-semibold shadow-sm hover:shadow-md"
                >
                    OK
                </button>
            </div>
