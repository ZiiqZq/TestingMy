<template>
  <div class="mt-2 fixed inset-y-0 left-0 z-10 flex flex-col items-center w-[3.75rem] h-screen overflow-y-hidden sidebar-scroll 
              text-[#52796F] bg-gray-100 border-r border-gray-100"
       id="sidebar">
      ...
      <div class="dropdown-container relative w-full">
        ...
        <div v-show="isMenuOpen" class="dropdown-menu bg-[#CAD2C5]">
          ...
          <router-link 
            ...
            :class="{ 'bg-[#f1f5f9]': $route.path === '/add-product' }"
            @click="closeMenu">
            <svg class="w-6 h-6 mr-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 10C3 8.34315 4.34315 7 6 7H14C15.6569 7 17 8.34315 17 10V18C17 19.6569 15.6569 21 14 21H6C4.34315 21 3 19.6569 3 18V10Z" stroke="#84A98C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M10 14V11M10 14V17M10 14H13M10 14H7" stroke="#84A98C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M7 3L18 3C19.6569 3 21 4.34315 21 6L21 17" stroke="#84A98C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          ...
          <router-link 
            to="/generate"
            class="dropdown-item flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-[#f8fafc] transition-colors border-b border-gray-100"
            :class="{ 'bg-[#f1f5f9]': $route.path === '/generate' }"
            @click="closeMenu">
            <svg class="w-6 h-6 mr-4" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4 9L20 9M8 9V20M6.2 20H17.8C18.9201 20 19.4802 20 19.908 19.782C20.2843 19.5903 20.5903 19.2843 20.782 18.908C21 18.4802 21 17.9201 21 16.8V7.2C21 6.0799 21 5.51984 20.782 5.09202C20.5903 4.71569 20.2843 4.40973 19.908 4.21799C19.4802 4 18.9201 4 17.8 4H6.2C5.0799 4 4.51984 4 4.09202 4.21799C3.71569 4.40973 3.40973 4.71569 3.21799 5.09202C3 5.51984 3 6.07989 3 7.2V16.8C3 17.9201 3 18.4802 3.21799 18.908C3.40973 19.2843 3.71569 19.5903 4.09202 19.782C4.51984 20 5.07989 20 6.2 20Z" stroke="#84A98C" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <div class="flex flex-col items-start">
          ...
          <router-link 
            to="/manage"
            class="dropdown-item flex items-center w-full px-4 py-3 text-sm text-gray-700 hover:bg-[#f8fafc] transition-colors border-b border-gray-100"
            :class="{ 'bg-[#f1f5f9]': $route.path === '/manage' }"
            @click="closeMenu">
